  ...
  return (
    <div
      ...
      className={cn(
        ...
        "scroller relative z-20 w-screen overflow-hidden  [mask-image:linear-gradient(to_right,transparent,#F0C200_20%,#F0C200_80%,transparent)]",
        className
      )}
    >
      <ul
      ...
      >
        {items.map((item, idx) => (
          <li
            ...
            className="w-[90vw] max-w-full relative border border-b-0
