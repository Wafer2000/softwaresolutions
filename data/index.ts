...
export const gridItems = [
  {
    id: 1,
    title: "Priorizamos la colaboración con los clientes, fomentando una comunicación abierta.",
    description: "",
  ...
  {
    id: 2,
    title: "Somos muy flexibles con la comunicación en diferentes zonas horarias.",
    description: "",
  ...
  {
    id: 3,
    title: "Nuestro conjunto tecnológico",
    description: "Nos esforzamos constantemente por mejorar",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 4,
    title: "Apasionados por la tecnología y el desarrollo.",
    description: "",
  ...
  {
    id: 6,
    title: "¿Quieres iniciar un proyecto con nosotros?",
    description: "",
    className: "lg:col-span-2 md:col-span-3 md:row-span-1",
    imgClassName: "",
